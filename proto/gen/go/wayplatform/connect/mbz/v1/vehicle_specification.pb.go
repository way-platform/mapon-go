...
// 	protoc        (unknown)
// source: wayplatform/connect/mapon/v1/vehicle_specification.proto
...
func (x *VehicleSpecification) Reset() {
	*x = VehicleSpecification{}
	mi := &file_wayplatform_connect_mapon_v1_vehicle_specification_proto_msgTypes[0]
...
func (x *VehicleSpecification_Engine) Reset() {
	*x = VehicleSpecification_Engine{}
	mi := &file_wayplatform_connect_mapon_v1_vehicle_specification_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_wayplatform_connect_mapon_v1_vehicle_specification_proto protoreflect.FileDescriptor

const file_wayplatform_connect_mapon_v1_vehicle_specification_proto_rawDesc = "" +
	"\n" +
	"6wayplatform/connect/mapon/v1/vehicle_specification.proto\x12\x1awayplatform.connect.mapon.v1\"\x82\x06\n" +
	...
	"\x0eprimary_engine\x18\x06 \x01(\v27.wayplatform.connect.mapon.v1.VehicleSpecification.EngineR\rprimaryEngine\x12b\n" +
	"\x10secondary_engine\x18\a \x01(\v27.wayplatform.connect.mapon.v1.VehicleSpecification.EngineR\x0fsecondaryEngine\x12&\n" +
	...
	"\x1ecom.wayplatform.connect.mapon.v1B\x19VehicleSpecificationProtoP\x01ZLgithub.com/way-platform/mapon-go/proto/gen/go/wayplatform/connect/mapon/v1;maponv1\xa2\x02\x03WCM\xaa\x02\x1aWayplatform.Connect.Mbz.V1\xca\x02\x1aWayplatform\\Connect\\Mbz\\V1\xe2\x02&Wayplatform\\Connect\\Mbz\\V1\\GPBMetadata\xea\x02\x1dWayplatform::Connect::Mbz::V1b\beditionsp\xe8\a"

var file_wayplatform_connect_mapon_v1_vehicle_specification_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_wayplatform_connect_mapon_v1_vehicle_specification_proto_goTypes = []any{
	(*VehicleSpecification)(nil),        // 0: wayplatform.connect.mapon.v1.VehicleSpecification
	(*VehicleSpecification_Engine)(nil), // 1: wayplatform.connect.mapon.v1.VehicleSpecification.Engine
}
var file_wayplatform_connect_mapon_v1_vehicle_specification_proto_depIdxs = []int32{
	1, // 0: wayplatform.connect.mapon.v1.VehicleSpecification.primary_engine:type_name -> wayplatform.connect.mapon.v1.VehicleSpecification.Engine
	1, // 1: wayplatform.connect.mapon.v1.VehicleSpecification.secondary_engine:type_name -> wayplatform.connect.mapon.v1.VehicleSpecification.Engine
...
func init() { file_wayplatform_connect_mapon_v1_vehicle_specification_proto_init() }
func file_wayplatform_connect_mapon_v1_vehicle_specification_proto_init() {
	if File_wayplatform_connect_mapon_v1_vehicle_specification_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wayplatform_connect_mapon_v1_vehicle_specification_proto_rawDesc), len(file_wayplatform_connect_mapon_v1_vehicle_specification_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_wayplatform_connect_mapon_v1_vehicle_specification_proto_goTypes,
		DependencyIndexes: file_wayplatform_connect_mapon_v1_vehicle_specification_proto_depIdxs,
		MessageInfos:      file_wayplatform_connect_mapon_v1_vehicle_specification_proto_msgTypes,
	}.Build()
	File_wayplatform_connect_mapon_v1_vehicle_specification_proto = out.File
	file_wayplatform_connect_mapon_v1_vehicle_specification_proto_goTypes = nil
	file_wayplatform_connect_mapon_v1_vehicle_specification_proto_depIdxs = nil
}
