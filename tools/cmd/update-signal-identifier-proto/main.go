...
func main() {
	const (
		signalIdentifierProtoPath = "wayplatform/connect/mapon/v1/signal_identifier.proto"
		annotationsProtoPath      = "wayplatform/connect/mapon/v1/annotations.proto"
		signalTypeProtoPath       = "wayplatform/connect/mapon/v1/signal_type.proto"
		signalUnitProtoPath       = "wayplatform/connect/mapon/v1/signal_unit.proto"
		signalEnumValueProtoPath  = "wayplatform/connect/mapon/v1/signal_enum_value.proto"
	)
	cmd := &cobra.Command{
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		fb.SetPackageName("wayplatform.connect.mapon.v1")
		...
		existingEnum := fileDescriptors[0].FindEnum("wayplatform.connect.mapon.v1.SignalIdentifier")
		if existingEnum == nil {
