...
import (
	...
	"github.com/way-platform/mapon-go/api/vehiclesv1"
...
func newListVehiclesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.ListVehicles(cmd.Context(), &mapon.ListVehiclesRequest{})
		if err != nil {
			return err
		}
		printJSON(response)
...
func newAssignVehiclesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.AssignVehicles(cmd.Context(), &mapon.AssignVehiclesRequest{
			VINs: args,
		})
		if err != nil {
			return err
...
func newDeleteVehiclesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.DeleteVehicles(cmd.Context(), &mapon.DeleteVehiclesRequest{
			VINs: args,
		})
		if err != nil {
			return err
...
func newListServicesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.ListServices(cmd.Context(), &mapon.ListServicesRequest{
			Details: *details,
		})
		if err != nil {
			return err
...
func newGetVehicleCompatibilityCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.GetVehicleCompatibility(cmd.Context(), &mapon.GetVehicleCompatibilityRequest{
			VIN: args[0],
		})
		if err != nil {
			return err
...
func newGetVehicleServicesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.GetVehicleServices(cmd.Context(), &mapon.GetVehicleServicesRequest{
			VIN: args[0],
		})
		if err != nil {
			return err
...
func newActivateVehicleServicesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		vin := args[0]
		services := make([]mapon.VehicleServices, 0, len(args)-1)
		for i := 1; i < len(args); i++ {
			services = append(services, mapon.VehicleServices{
				ServiceID:     args[i],
				DesiredStatus: mapon.DesiredStatusActive,
			})
		}
		response, err := client.PostVehicleServices(cmd.Context(), &mapon.PostVehicleServicesRequest{
			DesiredServiceStatusInput: []mapon.DesiredServiceStatusInput{
				{
					VIN:      vin,
					Services: services,
				},
...
func newDeactivateVehicleServicesCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		for i := 1; i < len(args); i++ {
			services = append(services, mapon.VehicleServices{
				ServiceID:     args[i],
				DesiredStatus: mapon.DesiredStatusInactive,
			})
		}
		response, err := client.PostVehicleServices(cmd.Context(), &mapon.PostVehicleServicesRequest{
			DesiredServiceStatusInput: []mapon.DesiredServiceStatusInput{
...
func newEnableDeltaPushCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		request := mapon.PatchVehiclesRequest{
...
func newGetVehicleSpecificationCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		response, err := client.GetVehicleSpecification(cmd.Context(), &mapon.GetVehicleSpecificationRequest{
			VIN: args[0],
		})
		if err != nil {
			return err
...
func newConsumeVehicleSignalsCommand() *cobra.Command {
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) error {
		...
		case mapon.RegionECE:
			bootstrapServer = mapon.KafkaBootstrapServerECE
		case mapon.RegionAMAPNA:
			bootstrapServer = mapon.KafkaBootstrapServerAMAPNA
		default:
...
func newOAuth2Client(cmd *cobra.Command) (*mapon.Client, error) {
...
func newClientWithAPIKey(cmd *cobra.Command) (*mapon.Client, error) {
	debug, err := cmd.Root().PersistentFlags().GetBool("debug")
	if err != nil {
		return nil, err
	}
